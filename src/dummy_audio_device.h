#ifndef SORA_UNITY_SDK_DUMMY_AUDIO_DEVICE_H_INCLUDED
#define SORA_UNITY_SDK_DUMMY_AUDIO_DEVICE_H_INCLUDED
...
class DummyAudioDevice : public webrtc::AudioDeviceModule {
 ...
 private:
  ...
  const size_t kSamplesPerFrame =
      static_cast<size_t>(kSamplingRate * kFrameLengthMs / 1000);
  ...
  webrtc::TaskQueueFactory* tackQueueFactory_;
};
